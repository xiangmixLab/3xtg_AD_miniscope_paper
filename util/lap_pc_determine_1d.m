function [pc,all_infoScore,all_infoScore_norm,all_coherence]=lap_pc_determine_1d(neuron_laps,behav_laps,binsize)
...
for i=1:size(neuron_laps,1)
    for j=1:size(neuron_laps,2)
        ...
        [pc{i,j},all_infoScore{i,j},all_infoScore_norm{i,j},all_coherence{i,j}] = permutingSpike_adapt_032623_1d(n,b.pos,b.time,'S',0,binsize,10,'all',0);  

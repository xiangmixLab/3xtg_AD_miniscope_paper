...
[lme1,anova_lme]=calculate_lme_011221(var,{categorical(type_idx11)},{categorical(trial_idx1),categorical(m_idx1)},'y~fix1+(fix1|random1)+(fix1|random2)');

type_idx12=type_idx1;
type_idx12(type_idx1==2)=0; % reference group is 1 or 0
[lme2,anova_lme]=calculate_lme_011221(var,{categorical(type_idx12)},{categorical(trial_idx1),categorical(m_idx1)},'y~fix1+(fix1|random1)+(fix1|random2)');

type_idx13=type_idx1;
type_idx13(type_idx1==3)=0; % reference group is 1 or 0
[lme3,anova_lme]=calculate_lme_011221(var,{categorical(type_idx13)},{categorical(trial_idx1),categorical(m_idx1)},'y~fix1+(fix1|random1)+(fix1|random2)');

type_idx14=type_idx1;
type_idx14(type_idx1==4)=0; % reference group is 1 or 0
[lme4,anova_lme]=calculate_lme_011221(var,{categorical(type_idx14)},{categorical(trial_idx1),categorical(m_idx1)},'y~fix1+(fix1|random1)+(fix1|random2)');
